...
feature_num = 3300
x1, y1, R1_confidence = get_interest_points(image1_bw, feature_num)
x2, y2, R2_confidence = get_interest_points(image2_bw, feature_num)
...
plt.show(); plt.savefig('../results/vis_circles.jpg')
c2 = show_correspondence_lines(image1, image2,
                    x1[matches[:num_pts_to_visualize, 0]], y1[matches[:num_pts_to_visualize, 0]],
                    x2[matches[:num_pts_to_visualize, 1]], y2[matches[:num_pts_to_visualize, 1]])
plt.figure(); plt.imshow(c2)
plt.show(); plt.savefig('../results/vis_lines.jpg')
